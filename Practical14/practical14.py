...
os.chdir('/Users/xsw0803/Desktop/Programme/IBI_practicals/IBI1_2024-25/Practical14')
...
if __name__ == "__main__":
    ...
    for ontology, (term_id, count) in max_terms.items():
        print(f"[DOM] {ontology}: {term_id} with {count} is_a references")
    ...
    for ontology, (term_id, count) in handler.max_terms.items():
        print(f"[SAX] {ontology}: {term_id} with {count} is_a references")
